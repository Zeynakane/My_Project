...
#Fonction pour l'inscription des utilisateurs dans la base de données
...
#Fonction pour la connection des utilisateurs 
...
#Fonction qui permet d'initialiser une connexion avec un serveur et d'interagir avec celui-ci
def openClientTunnel(host,
    ...
    print("Connexion au serveur IREDMAIL")
